...
{
	[SerializeField] private RoomGameManager _roomgameManagerPrefab;
	...
	public void JoinOrCreateLobby()
	{
		...
		NetworkRunner go=Instantiate(_runner);//gameManager생성
	...
	public void LeaveSession()
	{
		...
		Debug.Log("GameLauncher LeaveSession>>");
	}
	...
	{
		Debug.Log($"GameLauncher {player.PlayerId} disconnected.");
	...
	{
		Debug.Log($"GameLauncher OnShutdown {shutdownReason}");
		SetConnectionStatus(ConnectionStatus.Disconnected);
